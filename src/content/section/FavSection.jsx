import SoundAsset from "../components/FavSection/asset/SoundAsset.jpg";

function FavSection() {
  return (
    <>
      <div className="favCard mt-5 overflow-hidden max-w-sm rounded-2xl bg-[#171717]">
        <img src={SoundAsset} alt="" />
