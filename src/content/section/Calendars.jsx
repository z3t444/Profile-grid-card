      ...
      <div>
        <div className="mt-5">
          <div className="max-w-sm w-full shadow-lg">
            <div className="md:p-8 p-5 bg-[#171717] rounded-2xl">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="px-2 py-2 cursor-pointer flex w-full justify-center">
                          <p className=" text-gray-500 dark:text-gray-100 font-medium focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-500 hover:bg-indigo-500 text-base w-8 h-8 flex items-center justify-center bg-pink-400 duration-300 rounded-full">6</p>
                        </div>
                      </td>
                      <td>
                        <div className="px-2 py-2 cursor-pointer flex w-full justify-center">
                      ...
                      <td>
                        <div className="w-full h-full">
                          <div className="flex items-center justify-center w-full rounded-full cursor-pointer">
                            <a role="link" tabIndex="0" className="text-gray-100">
                              8
                            </a>
                          </div>
                        </div>
