      ...
      <div className="max-w-sm bg-[#171717] mt-5 overflow-hidden rounded-2xl">
        <div>
          ...
          <div className="for-desk px-5 py-4">
            ...
            <p className="text-gray-600 text-[13px] max-w-[300px] mt-2 leading-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod eius molestiae laudantium labore atque praesentium sunt, nobis deserunt a ipsam dicta illo error unde illum natus quam. Officiis, fuga deserunt.</p>
          </div>
        </div>
      </div>
    </>
